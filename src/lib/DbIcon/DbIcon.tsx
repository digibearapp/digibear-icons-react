import { DbIconProps, DbSvgDefinition } from "@digibearapp/digibear-common-types";
import { forwardRef, useContext } from "react"
import { DbIconContext, defaultDbIconContext, DigibearIconsRegistryContext } from "./DbIcon.types";
...
const DbIcon = forwardRef<SVGSVGElement, DbIconProps>((props, ref) => {
    ...
    const dbIconProps : DbIconProps = {
        ...
        iconStyle: props.iconStyle ?? contextIconStyle ?? defaultDbIconContext.iconStyle,
        size: props.size ?? contextSize ?? defaultDbIconContext.size,
        color: props.color ?? contextColor ?? defaultDbIconContext.color,
        secondaryColor: props.secondaryColor ?? contextSecondaryColor ?? defaultDbIconContext.secondaryColor,
        opacity: props.opacity ?? contextOpacity ?? defaultDbIconContext.opacity,
        secondaryOpacity: props.secondaryOpacity ?? contextSecondaryOpacity ?? defaultDbIconContext.secondaryOpacity,
        flippedH: props.flippedH ?? contextFlippedH ?? defaultDbIconContext.flippedH,
        flippedV: props.flippedV ?? contextFlippedV ?? defaultDbIconContext.flippedV,
    }
